...
![User interface of the purposes](cookie-glasses-purposes.gif?raw=true "Purposes")
![User interface of the features](cookie-glasses-features.gif?raw=true "Features")
